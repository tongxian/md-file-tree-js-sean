                ...
                if (err) {
                    ...
                    files.forEach(file => {
                        ...
                        fs.stat(filePath, (err, stats) => {
                            if (err) {
                            ...
                            } else if (stats.isDirectory() && file[0] !== '.' && file !== 'node_modules'&& file !== '_book'&& file !== 'assert'&& file !== 'assets') {
                                ...
                                if (file !== 'node_modules'&&file !== '_book'&& file !== 'assert'&& file !== 'assets'&& extname(file)=='md') {
